---
name: hzp-amz-2-1-product-analysis
...
- the top of the HTML or its report metadata must show the subdued source marker `HZP Amazon 2-1｜产品分析`;
...
- [ ] HTML report shows `HZP Amazon 2-1｜产品分析` near the title or in report metadata.
