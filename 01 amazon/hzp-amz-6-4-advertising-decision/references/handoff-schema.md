...
仅当 6-4 已有真实广告数据并形成可交接状态时生成，不提前完整做运营监控。
...
- 6-2 来源报告版本、6-4 报告版本、广告诊断时间范围和产品阶段
...
- 待继续观察项、数据不足项、下一周期 6-5 需要关注的广告指标

不得把搜索量、建议 Bid、BSR 或单日结果写成销量、真实 CPC 或稳定结论。6-5 作为下一周期经营诊断入口，继承本交接中的广告状态；完整运营监控仍由 6-5 负责。
...
交给下一周期 6-5 时补充：Search Term 生命周期阶段、核心成交词/排名词、当前推广目标、每日调整状态、操作卡、人工决策、执行方式、执行时间、调整前后数据窗口、1天/3天/7天验证结果、自然订单/排名变化和未解决风险。

人工决策与执行日志保存到 `06_SKILL分析报告/广告表现汇报优化日志/`；日志不是 6-4 正式版本，也不能成为最新版报告。
