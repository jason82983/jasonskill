...
- [hzp-amz-6-0-2-ai-precision-keyword-identification](<hzp-amz-6-0-2-ai-precision-keyword-identification/README.md>)：输入 Product_Code 后一次完成全部关键词的 AI Precision Brain V2 判断；Hard Conflict 前置、Answer Role 与反事实挑战先于四级精准度，完成后输出完整 CSV/HTML；不查询 ERP 或执行写操作。
